  ...
  return (
    ...
    >
      <div class="collection-card">
        <a class="collection-card__content" href="/launchpad/coreumpunks/">
          ...
          <div class="collection-card__content--detail">
            <div class="title">{data?.collection_info?.name}</div>
            <div class="content ">
              <div class="item">
                <div class="label">{(data)?.items_length} items</div>
                <div class="amount white">{""}</div>
              </div>
              {/* <div class="price">
                ...
                <div class="amount blue">
                  <img
                    ...
                    style={{ color: "transparent" }}
                  />
                  230<span class="dollar-amount">($15.24)</span>
                </div>
              </div> */}
            </div>
          </div>
